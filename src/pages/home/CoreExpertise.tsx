...
const CoreExpertise = () => {
    return (
        <section className="border border-white  w-screen core-expertise font-medium text-4xl font-poppins  text-white h-full flex flex-col items-center justify-evenly py-8 px-24 gap-14">
            ...
            <div className='skills-content max-w-[80%] gap-4 flex flex-col'>
                <div className='containetr_item group flex flex-row  border border-pink-main rounded-xl px-24 py-10 justify-evenly items-center gap-10 w-full hover:bg-gradient-blue-purple hover:scale-101 shadow-2xl bg-white/4 backdrop-blur-md transition-all duration-300 hover:border-white  '>
