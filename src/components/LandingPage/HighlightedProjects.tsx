...
const HighlightedProjects = () => {
  ...
  return (
    <section className='w-screen core-expertise font-medium text-4xl font-poppins  text-white h-full flex flex-col items-center justify-evenly py-8 px-24 gap-14 mt-8'>
      ...
      <div className='container-HP flex flex-row w-full p-24 gap-8'>
